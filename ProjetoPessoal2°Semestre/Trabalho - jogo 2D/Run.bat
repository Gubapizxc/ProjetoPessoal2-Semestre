...
:: Just a little reminder if you forgot to set the SDKs after downloading this project :)
echo.
echo Did you remember to update the FLEX_SDK and ANDROID_SDK paths in 
echo bat\SetupSDK.bat? Otherwise this message might be followed by some errors.
echo.

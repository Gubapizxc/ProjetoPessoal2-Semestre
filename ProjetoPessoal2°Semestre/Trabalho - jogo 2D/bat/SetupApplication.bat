...
:: Android packaging
set AND_CERT_NAME="JogoTeste"
set AND_CERT_PASS=123
set AND_CERT_FILE=cert\JogoTeste.p12
...
set IOS_PROVISION=cert\MyFirstMobileAIRApp.mobileprovision
...
set APP_ID=air.MyFirstMobileAIRApp

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MyFirstMobileAIRApp
